...
if (!isset($fila)) {
/****** falta hacer que el usuario no ingrese por url  para esto es el !isset pero no es post por ello no se como aqu se pasa por el id y el WHERE********/
    exit("Hubo error");
}
    // echo "<pre>";
    // print_r($fila);
...
$precio = (float) $precio;
//convertimos el recio a entero
$envio = 0;
$total = $precio + $envio;
//Metodo de pago
$compra = new Payer();
$compra->setPaymentMethod('paypal');
// solo aceptaremos pagos de paypal video 613/3:14
...
// Para mas transacciones ->setTransactions(array($transaccion, $transaccion2));
